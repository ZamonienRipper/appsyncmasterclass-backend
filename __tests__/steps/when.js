...
const a_user_calls_editMyProfile = async (user, input)=> {
  ...
  console.log(`[${user.username}] - edited my profile`)
...
const a_user_calls_getMyTimeline = async (user, limit, nextToken) => {
  const getMytTimeline = `query getMyTimeline($limit: Int!, $nextToken: String) {
  ...
  const data = await GraphQL(process.env.API_URL, getMytTimeline, variables, user.accessToken)
