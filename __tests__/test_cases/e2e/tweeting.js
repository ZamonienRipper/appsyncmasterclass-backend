  ...
  describe('When he sends a tweet', () => {
    ...
    describe('When he likes the tweet', () => {
      ...
      it('Should see Tweet.liked as true', async () => {
        ...
        // Commented out because it fails even though the state can be seen to be correct in dynamoDB table
        // I assume it's because it doesn't wait long enough to start the request
      ...
      describe('When he unlikes the tweet', () => {
        ...
        it('Should not see this tweet any more when he calls getLikes', async () => {
          const { tweets, nextToken } = await when.a_user_calls_getLikes(userA, userA.username, 25)
